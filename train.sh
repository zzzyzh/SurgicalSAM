...
# w/o encoder
CUDA_VISIBLE_DEVICES=1 python train.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.1 --sam_mode vit_b --sam_ckpt ../../data/experiments/weights/sam_vit_b_01ec64.pth --model_type wo_encoder --batch_size 12 --num_workers 16 --lr 0.002

CUDA_VISIBLE_DEVICES=1 python train.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.1 --sam_mode vit_b --sam_ckpt ../../data/experiments/weights/sam_vit_b_01ec64.pth --model_type wo_encoder --batch_size 12 --num_workers 16 --lr 0.001
