...
# bhx
# 0.1
python infer.py --resolution 512 --num_classes 4 --task ven --dataset bhx_sammed --scale 0.1 --sam_mode vit_b --model_type lora --train_time 20240718-1142 --vis True
python infer.py --resolution 512 --num_classes 4 --task ven --dataset bhx_sammed --scale 0.1 --sam_mode vit_b --model_type lora --train_time 20240718-1142 --vis True --volume True

# 0.05
python infer.py --resolution 512 --num_classes 4 --task ven --dataset bhx_sammed --scale 0.05 --sam_mode vit_b --model_type lora --train_time 20240720-1928 --vis True
python infer.py --resolution 512 --num_classes 4 --task ven --dataset bhx_sammed --scale 0.05 --sam_mode vit_b --model_type lora --train_time 20240720-1928 --vis True --volume True

# 0.01
python infer.py --resolution 512 --num_classes 4 --task ven --dataset bhx_sammed --scale 0.01 --sam_mode vit_b --model_type lora --train_time 20240723-0229 --vis True
python infer.py --resolution 512 --num_classes 4 --task ven --dataset bhx_sammed --scale 0.01 --sam_mode vit_b --model_type lora --train_time 20240723-0229 --vis True --volume True

###################

# sabs
# 0.1
python infer.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.1 --sam_mode vit_b --model_type lora --train_time 20240725-1053 --vis True
python infer.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.1 --sam_mode vit_b --model_type lora --train_time 20240725-1053 --vis True --volume True

# 0.05
python infer.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.05 --sam_mode vit_b --model_type lora --train_time 20240726-0010 --vis True
python infer.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.05 --sam_mode vit_b --model_type lora --train_time 20240726-0010 --vis True --volume True

# 0.01
python infer.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.01 --sam_mode vit_b --model_type lora --train_time 20240726-1320 --vis True
python infer.py --resolution 512 --num_classes 8 --task abdomen --dataset sabs_sammed --scale 0.01 --sam_mode vit_b --model_type lora --train_time 20240726-1320 --vis True --volume True
